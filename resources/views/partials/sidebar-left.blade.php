             ...
             <ul class="side-menu ">
                 ...
                 <li class="slide">
                     <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);"><i
                             class="side-menu__icon fe fe-box"></i><span class="side-menu__label">Apps</span><i
                             class="angle fe fe-chevron-down"></i></a>
                     <ul class="slide-menu">
                         <li class="side-menu__label1"><a href="javascript:void(0);">Apps</a></li>
                         <li><a class="slide-item" href="{{ route('all-task') }}">ALL TASK & LIST</a></li>
                         <li><a class="slide-item" href="{{ route('low') }}">LOW</a></li>
                         <li><a class="slide-item" href="{{ route('medium') }}">MEDIUM</a></li>
                         <li><a class="slide-item" href="{{ route('high') }}">HAIGH</a></li>
