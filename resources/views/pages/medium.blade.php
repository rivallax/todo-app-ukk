            ...
            <div class="card-body overflow-auto" style="max-height: 100vh;">
                ...
                <div class="d-flex gap-4 px-4 flex-nowrap" style="max-height: 100vh;">
                    @foreach ($lists as $list)
                        @php
                            $filteredTasks = $list->tasks->where('priority', 'medium');
                        @endphp

                        @if ($filteredTasks->isNotEmpty())
                            <div class="card flex-shrink-0 bg-warning-subtle" style="width: 18rem; max-height: 80vh;">
                                        ...
                                        <div class="card">
                                            <div class="card-header d-flex align-items-center justify-content-between">
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <span class="badge bg-pill bg-warning mt-1">
                                                        {{ $task->priority }}
                                                    </span>
                                                </div>
                    ...
                    @if ($lists->count() != 0)
                        <button type="button" class="btn bg-warning flex-shrink-0 me-3 px-1" style="width: 20rem; height: fit-content;"
                                data-bs-toggle="modal" data-bs-target="#addListModal">
                            <span class="d-flex align-items-center justify-content-center">
                                <i class="bi bi-plus fs-5"></i>
